...
const GET_EVENT_FOR_EMPLOYRE = "get_event_for_employer";
const GET_EVENT_FOR_STUDENT = "get_event_for_student";
const UPDATE_EVENT = "update_event";

const REGISTER = "register_for_event";
const GET_REGISTRATION_FOR_EMPLOYRE = "get_registrations_for_employer";
const GET_REGISTRATION_FOR_STUDENT = "get_registrations_for_student";
...
module.exports = {STUDENT_SIGNIN, STUDENT_SIGNUP, GET_STUDENT_DETAILS, UPDATE_STUDENT_PROFILE, GET_STUDENTS,
    ...
    CREATE_MESSAGE, GET_CONVERSATIONS, GET_CHAT, CREATE_EVENT, GET_EVENT_FOR_EMPLOYRE, GET_EVENT_FOR_STUDENT, UPDATE_EVENT,  REGISTER,
